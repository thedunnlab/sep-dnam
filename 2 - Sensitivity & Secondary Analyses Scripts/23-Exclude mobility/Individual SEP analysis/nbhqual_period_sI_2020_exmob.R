...
save(results.nbhqual.sI,file="/data/js95/ALSPAC/ARIES/Russell Sage/Jessie/Data/newDNAm/FWL_Results/Ex_mobility/results_nbhqual_period_exmob_062320_sI.Rdata")
