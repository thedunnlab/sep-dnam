...
results.income.sI<-select.LARS.complete.addmob(df, outcome.vec=outcome.vec, 
                            adver="income_bin",covars=c("WHITE", "Female", "mom_birthage", "ppregnum", "birth.weight","sustained.smoke",
...
save(results.income.sI,file="/data/js95/ALSPAC/ARIES/Russell Sage/Jessie/Data/newDNAm/FWL_Results/Ex_mobility/results_income_period_exmob_062320_sI.Rdata")
