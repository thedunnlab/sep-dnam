...
# output results 
results.EWAS.jobless<-results
save(results.EWAS.jobless,file="/data/js95/ALSPAC/ARIES/Russell Sage/Jessie/Data/newDNAm/EWAS/results_EWAS_jobless_081820.Rdata")
