...
# output results 
results.EWAS.major_F<-results
save(results.EWAS.major_F,file="/data/js95/ALSPAC/ARIES/Russell Sage/Jessie/Data/newDNAm/EWAS/results_EWAS_major_F_081820.Rdata")
