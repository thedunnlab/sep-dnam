...
# output results 
results.EWAS.nbhqual<-results
save(results.EWAS.nbhqual,file="/data/js95/ALSPAC/ARIES/Russell Sage/Jessie/Data/newDNAm/EWAS/results_EWAS_nbhqual_081820.Rdata")
