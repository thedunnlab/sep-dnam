...
# output results 
results.EWAS.income_reduction<-results
save(results.EWAS.income_reduction,file="/data/js95/ALSPAC/ARIES/Russell Sage/Jessie/Data/newDNAm/EWAS/results_EWAS_income_reduction_081820.Rdata")
