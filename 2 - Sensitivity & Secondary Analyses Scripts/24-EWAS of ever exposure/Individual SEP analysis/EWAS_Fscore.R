...
# output results 
results.EWAS.Fscore<-results
save(results.EWAS.Fscore,file="/data/js95/ALSPAC/ARIES/Russell Sage/Jessie/Data/newDNAm/EWAS/results_EWAS_Fscore_081820.Rdata")
