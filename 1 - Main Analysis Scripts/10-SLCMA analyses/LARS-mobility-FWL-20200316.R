...
loadlibs <- function(){
  ...
  library(glmnet,,lib.loc = "/data/js95/ALSPAC/ARIES/Russell Sage/Jessie/R_package")
  library(intervals,,lib.loc = "/data/js95/ALSPAC/ARIES/Russell Sage/Jessie/R_package")
  library(selectiveInference,lib.loc = "/data/js95/ALSPAC/ARIES/Russell Sage/Jessie/R_package")
}
