...
results.jobless.sI<-select.LARS.complete.addmob(df, outcome.vec=outcome.vec, 
                            adver="jobless_newbin",covars=c("WHITE", "Female", "mom_birthage", "ppregnum", "birth.weight","sustained.smoke",
...
save(results.jobless.sI,file="/data/js95/ALSPAC/ARIES/Russell Sage/Jessie/Data/newDNAm/FWL_Results/results_jobless_period_031720_sI.Rdata")
